...
local fenceHalfVertical = objectHandler.create("fence_half_vertical", 0, 0, 80, 130, 90, love.graphics.newImage("assets/images/outdoor_decor/fence/vertical/fenceHalfVertical1.png"), 50, 0, 1, 130, "static", 1, 0)
