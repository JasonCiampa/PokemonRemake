...
local tree = objectHandler.create("tree", 0, 0, 400, 600, 20, 556, love.graphics.newImage("assets/images/outdoor_decor/greenery/trees/tree1.png"), 0, 0, 400, 600, "static", 1, 0)
